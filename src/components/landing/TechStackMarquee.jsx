      ...
      <Container maxWidth="lg">
        ...
        <Box sx={{ overflow: 'hidden', whiteSpace: 'nowrap', width: '100%', py: 4, position: 'relative' }}>
          ...
          >
            ...
            <Box sx={{ mx: 4, display: "flex", flexDirection: "column", alignItems: "center", gap: 1 }}><img src={process.env.PUBLIC_URL + "/assets/aws-logo.svg"} alt="AWS" style={{ height: "50px", opacity: 0.7 }} /><Typography variant="caption" sx={{ color: "rgba(255,255,255,0.5)" }}>AWS</Typography></Box>
            ...
            <Box sx={{ mx: 4, display: "flex", flexDirection: "column", alignItems: "center", gap: 1 }}><img src={process.env.PUBLIC_URL + "/assets/openai-logo.svg"} alt="OpenAI" style={{ height: "50px", opacity: 0.7 }} /><Typography variant="caption" sx={{ color: "rgba(255,255,255,0.5)" }}>OpenAI</Typography></Box>
